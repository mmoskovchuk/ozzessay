...
@font-face {
    ...
    url('/wp-content/themes/ozessay/fonts/HelveticaLight.woff') format('woff');
}
@font-face {
    font-family: 'Helvetica';
    font-style: italic;
    ...
    url('/wp-content/themes/ozessay/fonts/FiraSans300Italic.woff') format('woff');
}
@font-face {
    font-family: 'Helvetica';
    font-style: normal;
    ...
    local('HelveticaRegular'),
    url('/wp-content/themes/ozessay/fonts/HelveticaRegular.woff') format('woff');
}
@font-face {
    font-family: 'Helvetica';
    font-style: italic;
    font-weight: 400;
    src: local('HelveticaItalic'),
    local('HelveticaItalic'),
    url('/wp-content/themes/ozessay/fonts/HelveticaItalic.woff') format('woff');
}
@font-face {
    font-family: 'Helvetica';
    font-style: normal;
    ...
    local('HelveticaMedium'),
    url('/wp-content/themes/ozessay/fonts/HelveticaMedium.woff') format('woff');
}
@font-face {
    font-family: 'Helvetica';
    font-style: normal;
    ...
    local('HelveticaBold'),
    url('/wp-content/themes/ozessay/fonts/HelveticaBold.woff') format('woff');
}
.bg-image {position: relative; max-width: 600px; margin: auto; line-height: 0px;}
.bg-image amp-img {max-height: 180px;}
.order_now p {text-align: center; font-size: 25px; line-height: 30px;}
.order_now {background: #fff; margin: 0 -15px; padding-bottom: 30px;}
.order_now b:nth-of-type(2) {color: #acb41a;}
.order_now a.button_order {border-bottom: none;margin: auto;background-color: #acb41a;color: #fff!important;
...
.amp-wp-article .amp-wp-article-featured-image.wp-caption {display:none;}
.footer-center {text-align: center;}
.link-pages a {font-size: 15px; border-right: 1px solid; padding-right: 8px; padding-left: 4px; color: #fff; text-decoration: underline;}
#footer a, #footer a:visited {color: #fff;} #footer a:hover, #footer a:active, #footer a:focus {color: #fff;}
.amp-wp-article h2, .amp-wp-article h3, .amp-wp-article h4 {text-align: center}
.cb{clear:both}
.number a {display: block; margin: 10px auto; font-weight: 600; text-decoration: none;}
...
html{background: <?php echo sanitize_hex_color( $header_background_color ); ?>;} body{background: <?php echo sanitize_hex_color( $theme_color ); ?>;color: <?php echo sanitize_hex_color( $text_color ); ?>;font-family: 'Helvetica'; font-weight: 300;line-height: 23px;}
p,ol,ul,figure {margin: 0 0 1em;padding: 0;} a,a:visited {color: #0097a7;}a:hover,a:active,a:focus {color: #0097a7;} .wp-caption amp-img{max-width: 100%}
...
.amp-wp-header {background: rgba(46,41,23,0.8); margin-top: -71px; position: relative; z-index: 1;}
.amp-wp-header .ampforwp-logo-area {color: <?php echo sanitize_hex_color( $header_color ); ?>;font-size: 1em;font-weight: 400;margin: 0 auto;max-width: 600px;padding: .5em 0;position: relative;}  .amp-wp-header .amp-wp-site-icon {background-color: <?php echo sanitize_hex_color( $header_color ); ?>;border: 1px solid <?php echo sanitize_hex_color(  $header_color ); ?>;border-radius: 50%;position: absolute;right: 18px;top: 10px;}
.amp-wp-article {color: <?php echo sanitize_hex_color( $text_color ); ?>;font-weight: 300;margin: 1.5em auto;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;} .amp-wp-article-header {align-items: center;align-content: stretch;display: flex;flex-wrap: wrap;justify-content: space-between;margin: 1.5em 16px 1.5em;}
.amp-wp-title {color: <?php echo sanitize_hex_color( $text_color ); ?>;display: block;flex: 1 0 100%;font-weight: 300; font-family: 'Helvetica';margin: 0; font-size: 32px;width: 100%;}.amp-wp-meta {color: <?php echo sanitize_hex_color( $muted_text_color ); ?>;display: inline-block;flex: 2 1 50%;font-size: .875em;line-height: 1.7em;margin: 0;padding: 0;}.ampforwp-meta-info{margin-top: 0px;}.amp-wp-article-header .amp-wp-meta:last-of-type {text-align: right;}.amp-wp-article-header .amp-wp-meta:first-of-type {text-align: left;}.amp-wp-byline amp-img,.amp-wp-byline .amp-wp-author {display: inline-block;vertical-align: middle;}.amp-wp-byline amp-img {border: 1px solid <?php echo sanitize_hex_color( $link_color ); ?>;border-radius: 50%;position: relative;margin-right: 6px;}.amp-wp-posted-on {text-align: right;}.hide-meta-info{ display: none; }
...
<?php if($redux_builder_amp['enable-single-social-icons'] && is_socialshare_or_socialsticky_enabled_in_ampforwp() ){ ?> .amp-wp-footer{background: #b42f00; padding: 30px 15px; color:#fff;}<?php } ?>
...
.amp-wp-footer p{ margin:0 0 10px 15px;}
.number a {margin: auto; color: #fff; display: block; max-width: 180px; border-radius: 3px; padding: 10px 0; height: 25px; text-indent: 30px; margin-top: 15px;}
